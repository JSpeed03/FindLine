...
// Query to get ABM data from the database
$query = "SELECT FirstName, LastName, Email, Gender, Phone, Address, Lastschool, Course, Date 
          FROM registrations 
          WHERE Course = 'BSENTREP' 
          ORDER BY Date, LastName, FirstName ASC";
...
header('Content-Disposition: attachment;filename="ECA-OVFTS BSENTREP Responses ' . date('Y-m-d') . '.csv"');
