              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  <tbody class="text-center text-sm bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    $sql = "SELECT * FROM registrations WHERE Course = 'BSME' ORDER BY Date,LastName,FirstName ASC";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                          ...
                          echo "<td class='px-2 py-1'><a href='delMARINEE.php?UserID=" . $row['UserID'] . "' class='btn-delete'>DELETE</a></td>";
                          echo "</tr>";
                        }
                    } else {
