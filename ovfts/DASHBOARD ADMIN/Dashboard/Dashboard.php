               ...
               <button id="exportExcelBtn" class="btn btn-primary">
                Export to Excel
                  ...
                  document.getElementById('exportExcelBtn').addEventListener('click', function() {
                      window.location.href = 'export.php'; // URL to your PHP export script
                  });
                  </script>
              <li class="relative">
                <button
                  ...
                  >
                    <li class="flex">
                      ...
                      >
                        ...
                        <form action="\ovfts\ovfts\DASHBOARD ADMIN\Login\logout.php" method="post">
...
$sql = "SELECT UserId, LastName, FirstName, Gender, Address, Course,Lastschool, Email, Phone, Date FROM registrations ORDER BY LastName,FirstName,Date ASC";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td class='px-2 py-1'><a href='del.php?UserID=" . $row['UserId'] . "' class='btn-delete'>DELETE</a></td>";
        echo "</tr>";
    }
} else {
