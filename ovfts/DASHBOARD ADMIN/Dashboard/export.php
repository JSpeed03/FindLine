...
// Query to get data from the database for the last 30 days
...
header('Content-Disposition: attachment;filename="ECA-OVFTS Survey Responses ' . date('Y-m-d') . '.csv"');

// Open the output stream for writing the CSV
$output = fopen('php://output', 'w');

// Define the column headers
$headers = ['First Name', 'Last Name', 'Email', 'Gender', 'Contact', 'Address', 'Last/Current School', 'Course', 'Date'];
